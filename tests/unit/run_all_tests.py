...
def run_all_tests(test_path: Optional[str] = None, verbose: bool = False) -> bool:
    ...
    if test_path is None:
        ...
        test_modules = [
            'tools.application.test_application_alert_config',
            'tools.application.test_application_analyze',
            'tools.application.test_application_catalog',
            'tools.application.test_application_metrics',
            'tools.application.test_application_resources',
            'tools.application.test_application_topology',
            'tools.application.test_application_global_alert_config',
            'tools.event.test_events_tools',
            'tools.infrastructure.test_infrastructure_analyze',
            'tools.infrastructure.test_infrastructure_catalog',
            'tools.infrastructure.test_infrastructure_metrics',
            'tools.infrastructure.test_infrastructure_resources',
            'tools.infrastructure.test_infrastructure_topology',
            'tools.log.test_log_alert_configuration',
            'prompts.application.test_application_alerts',
            'prompts.application.test_application_metrics',
            'prompts.application.test_application_catalog',
            'prompts.application.test_application_resources',
            'prompts.application.test_application_topology',
            'prompts.infrastructure.test_infrastructure_analyze',
            'prompts.infrastructure.test_infrastructure_metrics',
            'prompts.infrastructure.test_infrastructure_resources',
            'prompts.infrastructure.test_infrastructure_topology',
            'prompts.infrastructure.test_infrastructure_catalog',
        ]
