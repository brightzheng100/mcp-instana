...
automation_logger = logging.getLogger('mcp_instana.tools.automation.action_catalog')
...
with patch('mcp_instana.utils.with_header_auth', mock_with_header_auth):
    ...
    from mcp_instana.tools.automation.action_catalog import ActionCatalogMCPTools
...
class TestActionCatalogMCPTools(unittest.TestCase):
    ...
    @patch('mcp_instana.tools.automation.action_catalog.ActionSearchSpace')
