...
app_logger = logging.getLogger('mcp_instana.tools.application.application_settings')
app_logger.handlers = []
...
class TestApplicationSettingsMCPTools(unittest.TestCase):
    ...
    def setUp(self):
        ...
        patcher = patch('mcp_instana.tools.application.application_settings.debug_print')
