...
from mcp_instana.tools.log.log_alert_configuration import LogAlertConfigurationMCPTools

# Now patch the decorator
with patch('mcp_instana.utils.with_header_auth', mock_with_header_auth):
    # Re-import to get the patched version
    import importlib
    importlib.reload(sys.modules['mcp_instana.tools.log.log_alert_configuration'])
